...
import Help from '../assets/Helpcircle.png';
...
const Sidebar = () => {
  return (
    <div className="flex flex-col gap-8 w-full sm:w-64 h-screen bg-[#01014B] text-[#DFAD23] p-4 shadow-lg shadow-white">
      ...
      <Link
        to="/HelpCenter" 
        className="flex items-center mb-5 hover:text-[#DFAD23] hover:bg-[#01ECB812] hover:rounded-2xl text-center p-4 text-xl sm:text-2xl font-bold"
      >
        <img src={Help} className=" sm:w-8 sm:h-8"  />
        Help
      </Link>
    </div>
